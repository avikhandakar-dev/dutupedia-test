...
function RequireDoc() {
  return (
    <div className="container w-[90%] mx-auto relative ">
      <div className="  mt-16 h-auto rounded-2xl shadow-4xl md:shadow-3xl bg-white drop-shadow-md pb-5">
        <div className="flex pt-12 md:ml-10 ml-5 ">
          <Image src="/leftarrow.svg" alt="arrow" width={25} height={25} />
        </div>
        <div className="flex justify-center">
          <Image src="/documents.svg" alt="arrow" width={305} height={155} />
        </div>
        <p className="text-center">Admission Require Documents</p>

        <div className="flex p-2 justify-end md:mr-[190px] cursor-pointer">
          <Image src="/edit.svg" alt="arrow" width={40} height={40} />
        </div>

        <div className="md:w-[70%] w-[95%] mx-auto  rounded-xl shadow-4xl md:shadow-4xl bg-white drop-shadow-md ">
          ...
          <div className="flex flex-col ml-10 md:flex-row md:justify-around px-4 md:px-0">
            <div className="flex items-center md:w-[400px] w-[150px]">
              <div className="flex-col w-5 h-5">
                <Image src="/dot.svg" alt="arrow" width={10} height={10} />
              </div>
