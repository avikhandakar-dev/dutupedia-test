...
import { MemberCheckbox } from "../../styles/Checkbox";
import { useState } from "react";
function RegAllFileUpload() {
        ...
        <div className="w-[210px] h-[210px] border-2 border-solid border-[#Da1E37] mx-auto rounded-2xl shadow-4xl md:shadow-5xl bg-white drop-shadow-md relative">
          ...
          <div className="mx-auto md:w-[90%] w-[95%] h-auto ">
            ...
            <div className="flex flex-row space-x-5 md:space-x-16 lg:space-x-20 xl:space-x-44 md:items-center items-start">
              ...
              <p className="md:w-[200px] md:text-[20px] font-medium"> Blood Group:</p>
              <div className="relative h-10 md:w-[200px] text-gray-700 outline-none flex flex-row">
                <select
            ...
            <div className="flex flex-row space-x-5 md:space-x-10 lg:space-x-20 xl:space-x-44 md:items-center items-start">
              <div className="flex flex-col md:flex-row md:items-center ">
              <p className="lg:w-[200px] lg:text-[20px] font-medium">Nationality:</p>
              <div className="relative h-10 lg:w-[200px] text-gray-700 outline-none xl:ml-20">
              <input
                type="text"
              ...
              <div className="flex flex-col md:flex-row items-center">
              <p className="md:w-[200px] md:text-[20px] font-medium">Religion:</p>
              <div className="relative h-10 md:w-[200px] text-gray-700 outline-none flex flex-row md:-ml-20">
              <input
                type="text"
                className=" bg-[#F5F5F5] rounded-md border-solid border-[#CFCFCF] h-[38px] md:md:w-[200px] w-[130px]  outline-none pl-3"
                placeholder="Bangladeshi"
            ...
            <div className="flex flex-col md:flex-row  lg:space-x-10 xl:space-x-20  md:items-center">
              ...
              <input
                type="text"
                className=" bg-[#F5F5F5] rounded-md border-solid border-[#CFCFCF] h-[38px] md:w-[200px] w-[95%]  outline-none pl-3" placeholder="Md Julfiqer Ali"
              />
            </div>
            ...
            <div className="flex flex-row space-x-5 md:space-x-10 lg:space-x-20 xl:space-x-44 md:items-center items-start">
              <div className="flex flex-col md:flex-row md:items-center ">
              <p className="lg:w-[200px] lg:text-[20px] font-medium">Mobile( Require ):</p>
              <div className="relative h-10 lg:w-[200px] text-gray-700 outline-none xl:ml-20">
              <input
                type="text"
                className=" bg-[#F5F5F5] rounded-md border-solid border-[#CFCFCF] h-[38px] md:md:w-[200px] w-[130px]  outline-none pl-3"
              ...
              <div className="flex flex-col md:flex-row items-center">
              <p className="md:w-[200px] md:text-[20px] font-medium">Email(Optional):</p>
            ...
            <div className="flex flex-col md:flex-row  lg:space-x-10 xl:space-x-20  md:items-center">
              <p className="md:w-[200px] text-[20px] font-medium">Guardian Name:</p>
              <input
                type="text"
                className=" bg-[#F5F5F5] rounded-md border-solid border-[#CFCFCF] h-[38px] md:w-[200px] w-[95%]  outline-none pl-3" placeholder="Md Julfiqer Ali"
              />
            ...
            <div className="flex flex-row space-x-5 md:space-x-10 lg:space-x-20 xl:space-x-44 md:items-center items-start">
              <div className="flex flex-col md:flex-row md:items-center ">
              <p className="lg:w-[200px] w-[150px] lg:text-[18px] text-[14px] mt-5 font-normal"> Relation With Guardian:</p>
              <div className="relative h-10 lg:w-[200px] text-gray-700 outline-none xl:ml-20">
              <input
                type="text"
                className=" bg-[#F5F5F5] rounded-md border-solid border-[#CFCFCF] h-[38px] md:md:w-[200px] w-[130px]  outline-none pl-3"
              ...
              <div className="flex flex-col md:flex-row items-center">
              <p className="md:w-[200px] md:text-[20px] font-medium"> Mobile(Require):</p>
              <div className="relative h-10 md:w-[200px] text-gray-700 outline-none flex flex-row md:-ml-10">
              <input
                type="text"
                className=" bg-[#F5F5F5] rounded-md border-solid border-[#CFCFCF] h-[38px] md:md:w-[200px] w-[130px]  outline-none pl-3"
...
<div className="flex justify-between md:justify-around">
      ...
      focus:text-gray-700 focus:bg-white focus:outline-none"
          ...
          {/* here the carosole item will be found by forhad sir he has implement the functionality.please contact with him. */}

          <div className="flex flex-col justify-center items-center md:items-start">
<h2 className="font-medium">Upload Document</h2>
          <div className="flex cursor-pointer  bg-[#F5F5F5] w-[290px] h-[260px] items-center justify-center rounded-sm">
            <Image className="flex " src="/upload.svg" width={90} height={90} />
          </div>
</div>
        ...
        Payment
              ...
              <div className="relative inline-block w-[140px] md:w-[200px] text-gray-700 outline-none ">
                <div className="flex">
                  <input
                    type="text"
                    id="website-admin"
                    className="md:px-4 md:py-3 px-2 py-2 rounded-none rounded-l-md placeholder-blueGray-300 text-blueGray-600 relative bg-white text-sm border border-blueGray-300 outline-none focus:outline-none focus:ring w-full pr-1"
                    placeholder="9,0000,000৳"
                  />
            ...
            <div className="flex flex-row space-x-6 md:space-x-10">
                  <div className="flex flex-col">
                  <p className="md:w-[240px] md:text-[20px] text-[14px] mt-5 md:mt-3 font-medium">Admission Request For</p>
              <div className="relative inline-block w-[140px] md:w-[200px] text-gray-700 outline-none ">
                <select
                ...
                <div className="absolute inset-y-0 right-0 flex items-center px-2 pointer-events-none bg-[#Da1E37] rounded-r-lg">
                  ...
                  <div className="flex flex-col">
                  <p className=" w-[140px] md:w-[200px] md:text-[20px] font-medium">Section</p>
              <div className="relative inline-block md:w-[200px] text-gray-700 outline-none ">
                <select
                  className="md:w-[200px] w-[140px] h-10 pl-3 pr-6 text-base placeholder-gray-600 border rounded-lg appearance-none focus:shadow-none border-[#Da1E37] border-solid bg-transparent"
                  placeholder="Regular input"
...
export default RegAllFileUpload;
