            ...
            <div className="bg-white px-4 mt-4 md:rounded-md relative z-10 routine-table-body-section ">
              ...
              <div className="flex items-center border-t text-sm font-normal mt-4">
                <div className="flex border-2 rounded-md items-center w-full  md:h-20 h-[120px] shadow-5xl ">
                  <span className="pr-[70px] pl-3 -mt-10">01</span>
                  <div className="flex flex-none -mt-10">
                  ...
                  <div className="flex flex-col space-y-1 items-center justify-center -mt-10">
                  ...
                  <div className=" md:-mt-5 justify-center lg:right-[400px] md:right-[210px] absolute flex md:flex-col -space-y-3 invisible md:visible">
