...
function StdOnlineAccept() {
  return (
    <div className="container md:w-[90%] w-[95%] mx-auto relative ">
      <div className="  mt-16 h-auto rounded-2xl shadow-4xl md:shadow-3xl bg-white drop-shadow-md">
        ...
        <h2 className="text-center -mt-7 text-[#313131] font-medium md:text-[20px]">Dhaka City College</h2>
        ...
        <div className="flex  justify-end cursor-pointer md:w-[80%] w-full mx-auto ">
...
export default StdOnlineAccept;
