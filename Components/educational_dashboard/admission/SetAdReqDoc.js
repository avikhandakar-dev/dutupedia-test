    ...
    <div className="container w-[90%]  mx-auto relative ">
      <div className="  mt-16 h-[900px] md:h-[700px] rounded-2xl shadow-4xl md:shadow-3xl bg-white drop-shadow-md">
        <div className="flex pt-12 md:ml-10 ml-5">
          <Image src="/leftarrow.svg" width={25} height={25} alt="" />
        </div>
        <div className="flex justify-center">
          <Image src="/documents.svg" width={305} height={155} alt="" />
        </div>
        ...
        <div className="w-[90%] mx-auto flex sm:justify-between flex-wrap">
          <div className="flex flex-col w-full md:w-[300px]">
            ...
            <input
              type="text"
              className="border-1 border-[#a1a1a1] border-solid bg-[#F5F5F5] rounded-md  h-[38px] md:md:w-[290px] w-[95%]  outline-none pl-3"
              placeholder="Example: Birth Certificate, Passport Etc"
            />
            <button className="flex flex-row  bg-transparent border-none cursor-pointer items-center">
              <div className="flex items-center">
                <Image src="/roundedplus.svg" alt="" width={40} height={40} />
              </div>
