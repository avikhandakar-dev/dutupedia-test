    ...
    return (
        <div
            ...
            <ul className=" list-none w-full flex justify-between h-auto m-0">
                ...
                <li className="text-[16px] text-center w-[130px] pl-[30px]">Starting Time</li>
                <li className="text-[16px] text-center w-[125px] pl-[15px]">Ending Time</li>
                <li className="text-[16px] text-center w-[130px] pl-[0px]">Break Time</li>
                <li className="text-[16px] text-right w-[140px] pr-[35px]">Today Status</li>
